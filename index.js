<div class="titan-panel">
    <h3>🛡️ Titan Memory v10</h3>
    <div class="titan-desc">
        Qvink-style initialization.
    </div>
    <hr>
    ...
    <div class="titan-row" style="margin-top: 10px;">
        <button id="titan-save" class="titan-btn">💾 Save</button>
        <button id="titan-now" class="titan-btn">⚡ Force Update</button>
        <button id="titan-wipe" class="titan-btn red">🗑️ Wipe</button>
    </div>
